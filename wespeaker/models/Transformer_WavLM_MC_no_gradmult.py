...
from wespeaker.models.ssl.MCWavLM_no_gradmult import *
...
class WavLM_Base_MC_MHFA(nn.Module):
    ...
    def loadBackendParameters(self, param):

        self_state = self.back_end.state_dict()
        loaded_state = param
    ...
    def get_fusion_params(self):
        fus_params = self.model.get_fusion_params()
        for rf in self.rep_fusion_inst:
            fus_params.extend( list(rf.parameters()) )
        return fus_params
